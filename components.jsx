...
const { CATEGORIES, CAT_BY_ID, colorFor, initialsOf } = window.JT;
...
function CategoryTag({ catId, small }) {
...
// ============= LOGIN =============
function Login({ roster, onSignIn }) {
...
window.JTComponents = { Avatar, CategoryTag, Toast, Login };
})();
